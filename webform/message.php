...
<body>
  ...
  <div class="container mt-4">
    ...
    if (isset($_POST["inset-btn"])) {
      ...
      echo $checkgen = implode(",", $_POST['gen']);
      ...
      if ($run_update == true) {
        ...
        <strong></strong>DATA HAS BEEN UPDATED
    ...
    ?>
    <a class="btn btn-primary" href="home1.php">VIEW_DATA</a>
...
<script>
  ...
  function validateForm() {
    ...
    //validate dropdown
    if (hobbies == "") {
      printError("hobErr", "Please select option");
    ...
    // Validate gender
    if (study == "") {
      printError("studyErr", "Please select your qualification");
    } else {
      printError("studyErr", "");
      studyErr = false;
    }
